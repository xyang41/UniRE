...
class GNNBiaffine(nn.Module):
    def __init__(self, cfg, input_size, vocab):
        ...
        self.gcn1_encoder = GCNEncoder(input_size=self.input_size,
        ...
        self.gcn2_encoder = GCNEncoder(input_size=self.input_size,
                                          num_layers=cfg.gcn_layers,
                                          gcn_dropout=cfg.gcn_dropout,
                                          adj_dropout=cfg.adj_dropout,
                                          prune=cfg.prune,
        ...
        self.encoder_output_size = self.gcn1_encoder.get_output_dims()
        '''
        self.U = nn.Parameter(
    ...
    def forward(self, batch_inputs):
        ...
        batch_seq_encoder_repr1 = self.gcn1_encoder(batch_seq_tokens_encoder_repr, batch_seq_adj)          
        batch_seq_encoder_repr1 = torch.cat(
            [batch_seq_encoder_repr1,
             torch.ones_like(batch_seq_encoder_repr1[..., :1])], dim=-1)
        
        batch_seq_encoder_repr2 = self.gcn2_encoder(batch_seq_tokens_encoder_repr, batch_seq_adj)          
