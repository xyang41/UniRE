...
from modules.seq2seq_encoders.seq2seq_gat_encoder import GATEncoder
...
class GNNBiaffine(nn.Module):
    def __init__(self, cfg, input_size, vocab):
        ...
        self.gnn_encoder = GATEncoder(input_size=self.input_size,
                                          num_layers=cfg.gcn_layers,
                                          gat_dropout=cfg.gcn_dropout,
                                          adj_dropout=cfg.adj_dropout,
                                          prune=cfg.prune,
                                          min_threshold=cfg.min_threshold,
                                          max_threshold=cfg.max_threshold)
        self.encoder_output_size = self.gnn_encoder.get_output_dims()
        '''
        self.U = nn.Parameter(
    ...
    def forward(self, batch_inputs):
        ...
        batch_seq_encoder_repr = self.gnn_encoder(batch_seq_tokens_encoder_repr, batch_seq_adj)          
